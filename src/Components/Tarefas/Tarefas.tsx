                ...
                <View style={style.colView}>
                    <Text style={style.labeltext}>{props.nomeTarefa}</Text>
                    {
                        props.dataEntrega != null
                            ? <Text style={style.labeltext}>Data de entrega: {convertDateToString(props.dataEntrega)}</Text>
                            : <Text style={style.labeltext}>Data de entrega: Sem data de entrega</Text>
                    }
                </View>
